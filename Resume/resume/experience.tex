  ...
  \cventry
    ...
    {Fev. 2024 - Atual} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Atualmente, estou no projeto de uma das maiores petrolíferas LATAM, assumindo a liderança na automação de 300+ servidores com Ansible Automation Platform (AAP), com redução de 60\textbackslash{}\% no tempo de deploy e aumento da confiabilidade operacional. Desenvolvimento de automações em Python, PowerShell e YAML, aplicando práticas de DevOps no Azure (CloudOps).}
